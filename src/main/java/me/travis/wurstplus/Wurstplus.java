...
public class Wurstplus {
	...
	public static final String WURSTPLUS_NAME = "PastedWare";
	...
	public void WurstplusStarting(FMLInitializationEvent event) {
		...
		send_minecraft_log("get ready to use some shit");
		send_minecraft_log("shit client ready!");
